...
export default function Home() {
  ...
  return (
    <div className="px-4 md:px-8 pt-4 pb-4 max-w-3xl mx-auto">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <p className="text-white font-bold text-xl mb-1">Competitor Quiz</p>
      ...
      >
        <div className="card p-4 text-center">
          <BookOpen size={20} className="text-candor-teal mx-auto mb-1.5" />
          <div className="num text-xl font-bold text-white">{todayCount}</div>
          <div className="text-xs text-white/50 mt-0.5">Vandaag</div>
        </div>
        <div className="card p-4 text-center">
          <TrendingUp size={20} className="text-candor-green mx-auto mb-1.5" />
          <div className="num text-xl font-bold text-white">{stats?.gemScore ?? '—'}%</div>
          <div className="text-xs text-white/50 mt-0.5">Gem. score</div>
        </div>
        <div className="card p-4 text-center">
          <Award size={20} className="text-candor-orange mx-auto mb-1.5" />
          <div className="num text-xl font-bold text-white">{stats?.besteScore ?? '—'}%</div>
          <div className="text-xs text-white/50 mt-0.5">Beste score</div>
        </div>
      </motion.div>

      {/* Main cards — 2 cols mobile, 4 cols desktop */}
      <motion.div
        variants={container}
        initial="hidden"
        animate="show"
