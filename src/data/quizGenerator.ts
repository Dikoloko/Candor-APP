...
const locatieVragen: QuizQuestion[] = [
  ...
  {
    id: 'locatie-beste-score',
    vraag: 'Welk project heeft de hoogste competitieve score (5/5)?',
    type: 'multiple_choice',
    opties: shuffle(['Geen enkel (max is 4.25)', 'The Albert (4.2)', 'TONDO (4.15)', 'Kotter & Upkot (4.25)']),
    correctAntwoord: 'Geen enkel (max is 4.25)',
    uitleg: 'De hoogste score is 4.25/5, gedeeld door Kotter en Upkot. The Albert scoort 4.2/5, TONDO 4.15/5 en The Root scoort het laagst met 2.8/5.',
    categorie: 'Locatie',
    moeilijkheid: 'Hard',
    projectIds: ['kotter', 'upkot', 'the-albert', 'tondo'],
  },
  {
    id: 'locatie-laagste-score',
    vraag: 'Welk project heeft de laagste competitieve/locatiescore?',
    type: 'multiple_choice',
    opties: shuffle(['The Root (2.8)', 'The Arch (3.5)', 'Kotter (4.25)', 'TONDO (4.15)']),
    correctAntwoord: 'The Root (2.8)',
    uitleg: 'The Root scoort 2.8/5 — de laagste score. Dit heeft te maken met de perifere ligging in Zwijnaarde en de jonge, onervaren ontwikkelaar.',
    categorie: 'Locatie',
    moeilijkheid: 'Easy',
    projectIds: ['the-root'],
  },
...
const unitVragen: QuizQuestion[] = [
  ...
  },
  {
    ...
    type: 'ranking',
    opties: ['Kotter (126)', 'The Albert (110)', 'The Root (93)', 'TONDO (80)'],
    correctAntwoord: ['Kotter (126)', 'The Albert (110)', 'The Root (93)', 'TONDO (80)'],
...
const vergelijkingVragen: QuizQuestion[] = [
  ...
  },
  {
    ...
    type: 'ranking',
    opties: ['The Arch (aug. 2026)', 'TONDO (sept. 2026)', 'The Albert (sept. 2027)', 'Kotter (2027-28)'],
    correctAntwoord: ['The Arch (aug. 2026)', 'TONDO (sept. 2026)', 'The Albert (sept. 2027)', 'Kotter (2027-28)'],
  ...
  },
  {
    ...
    type: 'ranking',
    opties: ['Kotter (€149.500)', 'TONDO (€150.750)', 'The Root (€162.500)', 'The Albert (€165.000)'],
    correctAntwoord: ['Kotter (€149.500)', 'TONDO (€150.750)', 'The Root (€162.500)', 'The Albert (€165.000)'],
